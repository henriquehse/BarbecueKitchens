...
export function Footer() {
  return (
    <footer className="relative pt-24 pb-48 px-8 border-t border-white/5 bg-secondary/50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 relative z-10">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-sm font-bold uppercase tracking-tight">
            <li><a href="#" className="hover:text-accent transition-colors">A Experiência</a></li>
            <li><a href="#" className="hover:text-accent transition-colors">O Protocolo</a></li>
